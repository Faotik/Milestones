...
public class CompletedMilestonesCacheSaveData extends WorldSavedData {
    ...
    private static final String DATA_NAME = Milestones.MODID + "_CompletedMilestonesCacheSaveData";
    ...
    public void readFromNBT(NBTTagCompound nbt) {
        Milestones.completedMilestonesCache.clear();
        ...
        for (int i = 0; i < playerList.tagCount(); i++) {
            ...
            Milestones.completedMilestonesCache.put(uuid, milestones);
        }
    }
    ...
    public void writeToNBT(NBTTagCompound nbt) {
        ...
        for (var entry : Milestones.completedMilestonesCache.entrySet()) {
